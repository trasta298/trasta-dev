...
とりあえず "Create a GPT" から飛ぶと、GPT BuilderがどんなGPT作りたいねんと尋ねてくるので、適当に英語で答えてみる。  
...
↓ こんな感じで作れます
![やり取りの様子](./image/F-iNrP3bwAAjX01.jpg)  
...
![save](./image/1110pub.png)

という感じでできたのが、  
[https://chat.openai.com/g/g-O8ZTGX42y-sakura-translator](https://chat.openai.com/g/g-O8ZTGX42y-sakura-translator)  
暇があれば使ってみてね。

今回は簡単なものを作りましたが、ファイルをアップロードしてKnowlegeを与えてみたり、サードパーティのAPIを登録できたり、もちろんDALL-Eを使ったりすることもできるっぽいので、これから色々なGPTが増えて楽しくなりそうです。
